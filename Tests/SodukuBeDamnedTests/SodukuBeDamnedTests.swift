...
final class SodukuBeDamnedTests: XCTestCase {
    func testBoardSet() {
        ...
        // results.
        var board = Board()
        board.box5.space4.currentValue = 5
        XCTAssertEqual(board.box5.space4.currentValue, 5)
    }
    
    func testRow2() {
        var board = Board()
        board.box1.space4.currentValue = 4
        board.box2.space5.currentValue = 5
        board.box3.space6.currentValue = 6
